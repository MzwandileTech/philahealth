...
.btn-primary{
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%; padding-bottom: 20px;font-family: 'IBM Plex Sans', sans-serif;"> Welcome, Healthcare Administrator </h3>
    <div class="row">
  ...
  <div class="col-md-8" style="margin-top: 3%;">
    <div class="tab-content" id="nav-tabContent" style="width: 950px;">
      ...
      <form class="form-group" action="doctorsearch.php" method="post">
        <div class="row">
        <div class="col-md-10"><input type="text" name="doctor_contact" placeholder="search by email..." class = "form-control"></div>
...
<button id="downloadButton" style="
    ...
    padding: 0; 
    cursor: pointer;">
    <img src="images/icons8-excel-48.png" alt="Icon" style="
      width: 30px; 
      height: 30px;">
</button>
...
<script>
    document.getElementById('downloadButton').addEventListener('click', function() {
        ...
        window.location.href = 'doctor_report.php';
    });
</script>
    ...
    <div class="tab-pane fade" id="list-pat" role="tabpanel" aria-labelledby="list-pat-list">
      ...
      <button id="downloadButton2" style="
    border: none; 
    background: none; 
    padding: 0; 
    cursor: pointer;">
    <img src="images/icons8-excel-48.png" alt="Icon" style="
      ...
      <form class="form-group" action="appsearch.php" method="post">
        <div class="row">
        <div class="col-md-10"><input type="text" name="app_contact" placeholder="Search by phone number..." class = "form-control"></div>
        <div class="col-md-2"><input type="submit" name="app_search_submit" class="btn btn-primary" value="Search"></div></div>
      </form>

      <button id="downloadButton3" style="
    border: none; 
    background: none; 
    padding: 0; 
    cursor: pointer;">
...
<div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">...</div>
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          <div class="row">
                  <div class="col-md-4"><label>Doctor's  Full Name:</label></div>
...
<script>
    document.getElementById('downloadButton2').addEventListener('click', function() {
        // Redirect to the PHP script that generates the CSV
        window.location.href = 'patient_report.php';
    });
</script>
...
<script>
    document.getElementById('downloadButton3').addEventListener('click', function() {
        // Redirect to the PHP script that generates the CSV
        window.location.href = 'appDetails_report.php';
    });
</script>
...
<script>
    document.getElementById('downloadButton4').addEventListener('click', function() {
        // Redirect to the PHP script that generates the CSV
        window.location.href = 'presc_report.php';
    });
</script>
